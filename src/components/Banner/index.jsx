...
export default function Banner() {
  return (
    <section className="p-4 sm:p-48 h-2/5 bg-[url('components/Banner/banner.jpg')] bg-cover flex flex-col sm:flex-row justify-between sm:items-center mb-4">
      <div>
        <p className="text-[#fff] text-[48px] tracking-tighter drop-shadow-sm">
          Find{" "}
          <strong>
            <i>Adventures,</i>{" "}
          </strong>
